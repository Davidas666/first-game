...
func save_game():
	...
	file.store_var(Global1.basic_demage)
	file.store_var(Global1.player_demage)
	file.store_var(Global1.dienu_kiek)
...
func load_game():
	...
	Global1.basic_demage = file.get_var(Global1.basic_demage)
	Global1.player_demage = file.get_var(Global1.player_demage)
	Global1.dienu_kiek = file.get_var(Global1.dienu_kiek)
...
func _on_menu_2_pressed():
	$"../CanvasLayer/shop11".visible = true
